@echo off
echo Starting NoodleControl Mobile App Demo Server on Port 8081...
echo.
...
start "NoodleControl Demo Server (Port 8081)" cmd /k "title NoodleControl Frontend Server (Port 8081) && echo Starting NoodleControl Frontend Server on port 8081... && python server.py"

echo.
echo The demo server is starting in a new window on port 8081.
