 ...
 */
export class NoodleHoverProvider implements vscode.HoverProvider {
     ...
     */
    private getFunctionHover(word: string, line: string): vscode.Hover | undefined {
        const functionInfo: { [key: string]: string } = {
     ...
     */
    private getTypeHover(word: string): vscode.Hover | undefined {
     ...
     */
    private getAIHover(word: string, line: string): vscode.Hover | undefined {
        const aiInfo: { [key: string]: string } = {
            // AI keywords
