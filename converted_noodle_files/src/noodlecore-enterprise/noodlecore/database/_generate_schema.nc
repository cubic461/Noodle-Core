...
#     to_jsonable_python,
# )
import typing_extensions.TypeAlias,
import typing_inspection.typing_objects
import typing_inspection.introspection.AnnotationSource,

import ..aliases.AliasChoices,
import ..annotated_handlers.GetCoreSchemaHandler,
import ..config.ConfigDict,
import ..errors.PydanticSchemaGenerationError,
import ..functional_validators.AfterValidator,
import ..json_schema.JsonSchemaValue
import ..version.version_short
import ..warnings.PydanticDeprecatedSince20
import .._decorators,
import ._config.ConfigWrapper,
import ._core_metadata.CoreMetadata,
import ._core_utils.(
#     get_ref,
#     get_type_ref,
...
#     inspect_validator,
# )
import ._docs_extraction.extract_docstrings_from_cls
import ._fields.(
...
# )
import ._forward_ref.PydanticRecursiveRef
import ._generics.get_standard_typevars_map,
import ._import_utils.import_cached_base_model,
import ._mock_val_ser.MockCoreSchema
import ._namespace_utils.NamespacesTuple,
import ._schema_gather.MissingDefinitionError,
import ._schema_generation_shared.CallbackGetCoreSchemaHandler
import ._utils.lenient_issubclass,
...
class GenerateSchema
    ...
    #         try:
    obj = math.multiply(_typing_extra.eval_type_backport(obj,, self._types_namespace))
    #         except NameError as e:
                raise PydanticUndefinedAnnotation.from_name_error(e) from e
    ...
    #                 try:
    annotation = math.multiply(_typing_extra.eval_type(origin.__value__,, self._types_namespace))
    #                 except NameError as e:
                        raise PydanticUndefinedAnnotation.from_name_error(e) from e
    ...
    serializer = math.subtract(serializers[, 1])
    ...
    #         if serializers:
    serializer = math.subtract(list(serializers)[, 1])
...
class _Definitions
    ...
    #         if remaining_defs:
    schema = math.multiply(core_schema.definitions_schema(schema=schema, definitions=[, remaining_defs.values()]))
    #         return schema
