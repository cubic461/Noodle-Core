...
class QualityReport
    ...
    total_penalty + = math.multiply(weight, (1.0 - issue.confidence))

    #         # Score tussen 0-100
    self.score = math.multiply(max(0.0, 100.0 - (total_penalty, 10)))
...
class MonozukuriQualityLayers
    ...
    issues: Optional[List[QualityIssue]] = math.subtract(None), > str:)
    #         """
