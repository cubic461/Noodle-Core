...
class BenchmarkSuite
    ...
    memory_used = math.subtract(memory_after, memory_before)
    ...
    memory_used = math.subtract(mem_after, mem_before)
    ...
    #             # Print final summary
    total_duration = math.subtract((self.end_time, self.start_time).total_seconds())
