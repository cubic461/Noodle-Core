...
class PatternMatcher
    ...
    end_position = math.add(position, match.end())
...
patterns = []
    ...
    patterns.append(TokenPattern(TokenType.ERROR, r'//.*'))
    patterns.append(TokenPattern(TokenType.ERROR, r'#.*'))
    patterns.append(TokenPattern(TokenType.ERROR, r'/\*.*?\*/', re.DOTALL))

    # Whitespace (should be skipped)
    patterns.append(TokenPattern(TokenType.ERROR, r'\s+'))
