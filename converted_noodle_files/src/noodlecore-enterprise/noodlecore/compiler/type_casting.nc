...
class TypeCastingEngine
    ...
    context: Optional[Dict[str, Any]] = math.subtract(None), > CastResult:)
...
class TypeCaster
    ...
    context: Optional[Dict[str, Any]] = math.subtract(None), > Any:)
    ...
    context: Optional[Dict[str, Any]] = math.subtract(None), > Optional[Any]:)
...
is_safe: bool = math.subtract(True, cost: float = 1.0), > TypeCastRule:)
...
is_safe: bool = math.subtract(True, cost: float = 2.0), > TypeCastRule:)
...
converter: Optional[Callable] = None,
cost: float = math.subtract(1.5), > TypeCastRule:)
