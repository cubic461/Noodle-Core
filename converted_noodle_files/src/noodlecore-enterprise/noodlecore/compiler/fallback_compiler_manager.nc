...
try
    #     from ..trm_agent_base import TRMAgentBase, TRMAgentException, Logger
        from .trm_agent_compilation_bridge import (
    #         CompilationResult, CompilationStatus, CompilationRequest,
...
class FallbackCompilerManager(TRMAgentBase)
    ...
    context: Optional[Dict[str, Any]] = math.subtract(None), > CompilationResult:)
    #         """
    ...
    memory_usage: int = math.subtract(0), > CompilationResult:)
    #         """
    ...
    max_memory = math.multiply(2, 1024 * 1024 * 1024)
