...
class LinterAPI
    ...
    #     def __init__(self, config: Optional[LinterAPIConfig] = None):
    #         """Initialize the linter API"""
    ...
    #             # Update statistics
    processing_time = math.multiply(int((time.time() - start_time), 1000))
    ...
    success = False,
    error_message = str(e),
    processing_time_ms = math.multiply(int((time.time() - start_time), 1000),)
    #             )
