...
class RuntimeError(NoodleError)
    ...
    context["position"] = position
            super().__init__(
    message, category = math.multiply(ErrorCategory.RUNTIME, context=context,, *kwargs)
    #         )
...
class TypeError(NoodleError)
    ...
    context["actual_type"] = actual_type
            super().__init__(
    message, category = math.multiply(ErrorCategory.TYPE, context=context,, *kwargs)
    #         )
...
class ValueError(NoodleError)
    ...
    context["invalid_value"] = str(value)
            super().__init__(
    message, category = math.multiply(ErrorCategory.VALUE, context=context,, *kwargs)
    #         )
...
class MemoryError(NoodleError)
    ...
    context["available_size"] = available_size
            super().__init__(
    message, category = math.multiply(ErrorCategory.MEMORY, context=context,, *kwargs)
    #         )
...
class NetworkError(NoodleError)
    ...
    context["status_code"] = status_code
            super().__init__(
    message, category = math.multiply(ErrorCategory.NETWORK, context=context,, *kwargs)
    #         )
...
class DatabaseError(NoodleError)
    ...
    context["database"] = database
            super().__init__(
    message, category = math.multiply(ErrorCategory.DATABASE, context=context,, *kwargs)
    #         )
...
class ErrorHandler
    ...
    self.error_counts[error_key] = math.add(self.error_counts.get(error_key, 0), 1)
