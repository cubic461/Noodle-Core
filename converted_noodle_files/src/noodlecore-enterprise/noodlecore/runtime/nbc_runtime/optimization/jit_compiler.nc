...
class JITConfig
    ...
    optimization_level: int = math.subtract(2  # 0, 3)
...
class JITCompiler
    ...
    mlir_time = math.subtract(time.time(), start_time)
    ...
    #             # Apply optimizations
    optimized_bytecode = self._apply_optimizations(bytecode, func_name)
    result.optimization_time = math.subtract(time.time(), start_time)
    ...
    #                 )
    result.mlir_time = math.subtract(time.time(), start_time - result.optimization_time)
    #             else:
    ...
    result.compilation_time = math.subtract(time.time(), start_time)
    result.success = True
