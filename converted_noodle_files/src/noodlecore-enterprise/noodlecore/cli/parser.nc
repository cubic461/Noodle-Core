...
import os
import argparse.SUPPRESS,
import collections.OrderedDict

import virtualenv.config.convert.get_type
import virtualenv.config.env_var.get_env_var
import virtualenv.config.ini.IniConfig
...
class HelpFormatter(ArgumentDefaultsHelpFormatter)
    ...
    super().__init__(prog, max_help_position = math.multiply(32, width=240,, *kwargs))
