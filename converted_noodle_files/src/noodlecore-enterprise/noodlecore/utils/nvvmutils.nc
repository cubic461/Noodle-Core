...
function declare_atomic_cas_int(lmod, isize)
...
function atomic_cmpxchg(builder, lmod, isize, ptr, cmp, val)
    out = builder.cmpxchg(ptr, cmp, val, 'monotonic', 'monotonic')
        return builder.extract_value(out, 0)


function declare_atomic_add_float32(lmod)
...
function declare_atomic_add_float64(lmod)
...
function declare_atomic_sub_float32(lmod)
...
function declare_atomic_sub_float64(lmod)
...
function declare_atomic_inc_int32(lmod)
...
function declare_atomic_inc_int64(lmod)
...
function declare_atomic_dec_int32(lmod)
...
function declare_atomic_dec_int64(lmod)
...
function declare_atomic_max_float32(lmod)
...
function declare_atomic_max_float64(lmod)
...
function declare_atomic_min_float32(lmod)
...
function declare_atomic_min_float64(lmod)
...
function declare_atomic_nanmax_float32(lmod)
...
function declare_atomic_nanmax_float64(lmod)
...
function declare_atomic_nanmin_float32(lmod)
...
function declare_atomic_nanmin_float64(lmod)
...
function declare_cudaCGGetIntrinsicHandle(lmod)
...
function declare_cudaCGSynchronize(lmod)
...
function declare_string(builder, value)
...
function call_sreg(builder, name)
...
function get_global_id(builder, dim)
