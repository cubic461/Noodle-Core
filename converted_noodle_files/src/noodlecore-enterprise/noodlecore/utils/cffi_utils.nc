...
import types.BuiltinFunctionType
import ctypes
...
function get_pointer(cffi_func)
    #     """
...
function map_type(cffi_type, use_record_dtype=False)
    #     """
...
function map_struct_to_record_dtype(cffi_type)
...
function make_function_type(cffi_func, use_record_dtype=False)
    #     """
...
function register_type(cffi_type, numba_type)
    #     """
