...
import ._log.log
import .dir_util.mkpath
import .errors.DistutilsExecError
import .spawn.spawn
...
function check_archive_formats(formats)
...
#     try:
filename = math.multiply(func(base_name, base_dir,, *kwargs))
#     finally:
#         if root_dir is not None:
