...
import numba.core.registry.cpu_target
import numba.core.typeconv.Conversion
import numba.core.extending.intrinsic
import numba.core.errors.(TypingError,
#                                NumbaTypeError)


function _as_bytes(builder, ptr)
...
# @intrinsic
function _cast(typingctx, val, typ)
    #     """Cast *val* to *typ*
    #     """
...
function _sentry_safe_cast(fromty, toty)
...
function _sentry_safe_cast_default(default, valty)
...
# @intrinsic
function _nonoptional(typingctx, val)
...
function _container_get_data(context, builder, container_ty, c)
...
function _container_get_meminfo(context, builder, container_ty, c)
...
function _get_incref_decref(context, module, datamodel, container_element_type)
...
function _get_equal(context, module, datamodel, container_element_type)
        assert datamodel.contains_nrt_meminfo()
