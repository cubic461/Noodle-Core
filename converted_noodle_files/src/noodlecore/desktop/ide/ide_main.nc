...
import .file_explorer.FileExplorer
import .code_editor.CodeEditor
import .ai_panel.AIPanel
import .terminal_console.TerminalConsole
import .tab_manager.TabManager


class IDEMode(enum.Enum)
    #     # IDE operation modes.
...
class NoodleCoreIDE
    ...
    #     def __init__(self, config: IDEConfiguration = None, mode: IDEMode = IDEMode.FULL_APPLICATION):
