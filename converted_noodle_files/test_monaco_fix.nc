...
function test_html_loading()
    ...
    response = requests.get('http://localhost:8080/enhanced-ide.html', timeout=5)
            print(f"✅ HTML page load: {response.status_code}")
    ...
    #             if 'initializeMonacoLoader' in content:
                    fixes_present.append("✅ Enhanced Monaco loader")

    #             # Check for error handling
    #             if 'showEditorError' in content:
                    fixes_present.append("✅ Error handling")

    #             # Check for fallback mechanism
    #             if 'fallbackToBasicEditor' in content:
                    fixes_present.append("✅ Fallback mechanism")

    #             # Check for timeout handling
    #             if 'loadTimeout' in content:
                    fixes_present.append("✅ Timeout handling")

    #             # Check for proper dependencies
    #             if 'monaco-editor/0.45.0' in content:
                    fixes_present.append("✅ Monaco dependency")
    ...
    #             if len(fixes_present) >= 4:
                    print("✅ All major Monaco Editor fixes are present!")
    #                 return True
    #             else:
...
function main()
    #     """Run all tests"""
        print("🔧 Testing Monaco Editor Fixes")
    print(" = " * 40)
    ...
    #     if passed == total:
            print("🎉 All tests passed! Monaco Editor fixes are working.")
            print("\n🚀 You can now test the enhanced IDE at:")
            print("   http://localhost:8080/enhanced-ide.html")
            print("\n✨ The Monaco Editor should now:")
    ...
    #     else:
            print("⚠️  Some tests failed. Please check the server and fixes.")
            sys.exit(1)
