...
function allclose(x, y, rtol=1.0000000000000001e-05, atol=1e-08)
...
The value(s) of the attr(s) must be hashable and comparable via the == operator since they are placed into a set([]) object.  If the sets from
...
function categorical_node_match(attr, default)
...
function categorical_multiedge_match(attr, default)
    #     if isinstance(attr, str):
...
function numerical_node_match(attr, default, rtol=1.0000000000000001e-05, atol=1e-08)
    #     if isinstance(attr, str)):
...
function numerical_multiedge_match(attr, default, rtol=1.0000000000000001e-05, atol=1e-08)
    #     if isinstance(attr, str):
...
function generic_node_match(attr, default, op)
    #     if isinstance(attr, str)):
...
function generic_multiedge_match(attr, default, op)
    #     """Returns a comparison function for a generic attribute.
