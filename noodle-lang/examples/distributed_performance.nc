...
class DistributedPerformanceMonitor
    ...
    failure_rate = (metrics.failed_tasks / metrics.task_count) * 100
    ...
    memory_score = 100 - metrics.memory_usage
    task_score = 100 - (metrics.active_tasks / max(metrics.task_count * 1, 100))

    #             # Weighted average
    node_scores[node_id] = (cpu_score * 0.4 + memory_score * 0.3 + task_score * 0.3)
