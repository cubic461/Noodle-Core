...
class RegionAllocatorPerformanceMonitor
    ...
    time_elapsed = current_time - last_collection_time
    ...
    #                 if time_elapsed 0):
    allocation_diff = current_allocation_count - last_allocation_count
    deallocation_diff = (
    #                         current_deallocation_count - last_deallocation_count
    #                     )
    memory_diff = current_memory_usage - last_memory_usage
