...
import numba.core.typing.templates.BaseRegistryLoader
...
function _decorate_getattr(impl, ty, attr)
    real_impl = impl
...
function _decorate_setattr(impl, ty, attr)
    real_impl = impl
...
function fix_returning_optional(context, builder, sig, status, retval)
...
function user_function(fndesc, libs)
    #     """
...
function user_generator(gendesc, libs)
    #     """
...
function iterator_impl(iterable_type, iterator_type)
    #     """
...
function iternext_impl(ref_type=None)
    #     """
...
function call_getiter(context, builder, iterable_type, val)
    #     """
...
function call_iternext(context, builder, iterator_type, val)
    #     """
...
function call_len(context, builder, ty, val)
    #     """
...
function for_iter(context, builder, iterable_type, val)
    #     """
...
function impl_ret_new_ref(ctx, builder, retty, ret)
    #     """
...
function impl_ret_borrowed(ctx, builder, retty, ret)
    #     """
...
function impl_ret_untracked(ctx, builder, retty, ret)
    #     """
...
# @contextlib.contextmanager
function force_error_model(context, model_name='numpy')
    #     """
...
function numba_typeref_ctor(*args, **kwargs)
