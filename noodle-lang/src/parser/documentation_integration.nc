...
class DocumentationIntegration
    ...
    generation_time = (end_time - start_time).total_seconds() * 1000  # Convert to milliseconds
    ...
    #             # Update performance stats
    end_time = datetime.now()
    export_time = (end_time - start_time).total_seconds() * 1000  # Convert to milliseconds
