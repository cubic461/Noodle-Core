#!/usr/bin/env python3
"""
Noodle Core::Native Gui Ide Persistent - native_gui_ide_persistent.py
...
class NoodleCoreIDE:
    ...
    def create_main_layout(self):
        ...
        self.model_status_label = ttk.Label(ai_input_frame, text="âœ…", font=('Arial', 10))
...
Please provide helpful, specific, and actionable assistance based on the context above. If relevant, suggest code improvements, best practices, or NoodleCore-specific solutions."""
    ...
    def show_ai_settings(self):
        ...
        def save_settings():
            ...
            messagebox.showinfo("Settings", "AI settings saved persistently! \n\nâœ… Your API keys are now remembered and will auto-load next time.\nâœ… Click 'AI â†’ Refresh Models' to load models with your API keys.")
...
ðŸš€ Persistent Features:
â€¢ AI provider and model are remembered
â€¢ API keys are securely stored and auto-loaded
â€¢ Recent models are tracked and shown first
â€¢ Context mode preference is saved
â€¢ Project directory is remembered
â€¢ Window geometry is remembered
â€¢ Recent files list is maintained
...
"""
    ...
    def run(self):
        ...
        self.ai_chat_output.insert('end', "ðŸ’¾ NoodleCore IDE Persistent Settings - Never Re-enter Again!\n\n")
        self.ai_chat_output.insert('end', "âœ… **What's New - Persistent Settings:**\n")
        self.ai_chat_output.insert('end', "â€¢ AI provider and model are remembered\n")
        self.ai_chat_output.insert('end', "â€¢ API keys are securely stored and auto-loaded\n")
        self.ai_chat_output.insert('end', "â€¢ Recent models are tracked and shown first\n")
        self.ai_chat_output.insert('end', "â€¢ Context mode preference is saved\n")
        self.ai_chat_output.insert('end', "â€¢ Project directory is remembered\n")
        self.ai_chat_output.insert('end', "â€¢ Window geometry is remembered\n\n")
        self.ai_chat_output.insert('end', "ðŸš€ **No More Re-entering:**\n")
        ...
        self.ai_chat_output.insert('end', f"ðŸ“ Settings location: {self.settings.config_dir}\n")
