#!/usr/bin/env python3
"""
Noodle Core::Native Gui Ide Smart Fixed - native_gui_ide_smart_fixed.py
...
"""
NoodleCore Native GUI IDE - Smart AI Integration (Fixed)
Enhanced with intelligent context and useful AI prompts
"""
...
class NoodleCoreIDE:
    """Main NoodleCore Native GUI IDE class with smart AI integration."""
    
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("NoodleCore Native GUI IDE - Smart AI")
    ...
    def create_main_layout(self):
        ...
        # AI Chat panel
        ai_frame = ttk.LabelFrame(bottom_panel, text="Smart AI Assistant (Context-Aware)", padding=5)
        ...
        self.ai_context_var = tk.StringVar(value="Smart")
        ...
        # Status bar
        self.status_bar = ttk.Label(self.root, text="Initializing Smart AI IDE...", relief='sunken', anchor='w')
        ...
        self.create_new_tab("Welcome to NoodleCore IDE", "# Welcome to NoodleCore Native GUI IDE - Smart AI\n\nThis IDE now has intelligent AI integration with context awareness!\n\nâœ… **Smart AI Features:**\n- Context-aware AI conversations\n- Current file analysis and insights\n- Project-aware suggestions\n- NoodleCore-specific help\n- Code review and optimization\n- Error diagnosis and fixes\n\nðŸš€ **How to Use Smart AI:**\n1. Open a NoodleCore file (.nc)\n2. Use Run â†’ Analyze Code with AI\n3. Or use AI â†’ Smart Chat for general help\n4. The AI will see your code and project context!\n\n**Current Status:** Loading AI models...")
    ...
    def analyze_code_with_ai(self):
        ...
        self.ai_chat_output.insert('end', "ðŸ¤– **AI Code Analysis Starting...**\n")
        self.ai_chat_output.see('end')
    ...
    def ai_code_review(self):
        ...
        self.ai_chat_output.insert('end', "ðŸ” **AI Code Review Starting...**\n")
        self.ai_chat_output.see('end')
    ...
    def send_smart_ai_request(self, event=None):
        ...
        self.ai_chat_output.insert('end', f"ðŸ‘¤ User: {user_message[:100]}{'...' if len(user_message) > 100 else ''}\n")
        
        # Show typing indicator
        self.ai_chat_output.insert('end', f"ðŸ¤– {provider}/{model}: Thinking with context...")
        self.ai_chat_output.see('end')
...
Be thorough and constructive in your review."""
    ...
    def _get_development_context(self):
        ...
        return "\n".join(f"â€¢ {part}" for part in context_parts) if context_parts else "â€¢ No specific context available"
...
Please provide helpful, specific, and actionable assistance based on the context above. If relevant, suggest code improvements, best practices, or NoodleCore-specific solutions."""
    ...
    def _show_code_analysis(self, response, is_error=False):
        ...
        if is_error:
            ...
            self.ai_chat_output.insert('end', f"ðŸ” **AI Code Analysis:**\n{response}\n\n")
    ...
    def _show_code_review(self, response, is_error=False):
        ...
        if is_error:
            ...
            self.ai_chat_output.insert('end', f"ðŸ“‹ **AI Code Review:**\n{response}\n\n")
    ...
    def show_about(self):
        """Show about dialog."""
        about_text = """NoodleCore Native GUI IDE - Smart AI Version
Version 3.0 - Intelligent Context-Aware AI

ðŸš€ Smart Features:
â€¢ Context-aware AI conversations
â€¢ Current file analysis and insights
â€¢ Project-aware suggestions
â€¢ NoodleCore-specific help
â€¢ Code review and optimization
â€¢ Error diagnosis and fixes
â€¢ Intelligent prompt enhancement

ðŸ’¡ Usage:
1. Open/edit files to provide context
2. Use Run â†’ Analyze Code with AI
3. Use AI â†’ Smart Chat for contextual help
4. AI sees your code and project structure!
"""
    ...
    def run(self):
        ...
        self.ai_chat_output.insert('end', "ðŸ§  NoodleCore IDE Smart AI - Context-Aware Assistant Ready!\n\n")
        self.ai_chat_output.insert('end', "âœ… **Smart AI Features:**\n")
        self.ai_chat_output.insert('end', "â€¢ Real-time code analysis and insights\n")
        self.ai_chat_output.insert('end', "â€¢ Project-aware AI suggestions\n")
        self.ai_chat_output.insert('end', "â€¢ NoodleCore development assistance\n")
        self.ai_chat_output.insert('end', "â€¢ Code review and optimization\n")
        self.ai_chat_output.insert('end', "â€¢ Error diagnosis and fixes\n\n")
        self.ai_chat_output.insert('end', "ðŸš€ **How Smart AI Works:**\n")
        self.ai_chat_output.insert('end', "1. Open/edit files to give AI context\n")
        self.ai_chat_output.insert('end', "2. Use Run â†’ Analyze Code with AI\n")
        self.ai_chat_output.insert('end', "3. AI sees your code, project, and provides insights\n")
        self.ai_chat_output.insert('end', "4. Get specific, actionable recommendations\n\n")
        self.ai_chat_output.insert('end', "Models are being loaded...\n\n")
