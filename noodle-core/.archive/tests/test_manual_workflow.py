#!/usr/bin/env python3
"""
Test Suite::Noodle Core - test_manual_workflow.py
...
"""
Manual test for Python to NoodleCore workflow with archiving.
"""
...
def main():
    ...
    # Test file
    test_file = "noodle-core/test_simple_python.py"
    ...
    if result['success']:
        ...
        if os.path.exists(result['nc_file']):
            print(f"âœ“ NC file exists at: {result['nc_file']}")
        else:
            print(f"âœ— NC file NOT found at: {result['nc_file']}")
