#!/usr/bin/env python3
"""
Test Suite::Noodle Core - test_diff_simple.py
...
"""
Simple test for diff highlighting functionality without Unicode characters.
"""
...
'''
    ...
    try:
        ...
        # Manually register the callback to simulate IDE registration
        si_integration.set_ide_callback(mock_ide._apply_diff_highlighting_to_editor)
        
        # Simulate the improvement process
        print("\n[TOOL] Simulating improvement process...")
        
        # Store original content manually
        si_integration._original_content = {temp_file_path: test_content}
        
        # Write improved content to file
        with open(temp_file_path, 'w') as f:
            f.write(improved_content)
        
        # Manually trigger diff highlighting
        si_integration._show_diff_highlighting(temp_file_path, improved_content, improvement)
        
        print("[OK] Improvement process completed!")
