#!/usr/bin/env python3
"""
Test Suite::Noodle Core - test_native_gui_ide.py
...
def hello_world():
    ...
    def test_file_icons(self):
        ...
        self.assertEqual(nc_icon, "ðŸš€ NoodleCore")
        
        py_icon = self.explorer.get_file_icon("script.py")
        self.assertEqual(py_icon, "ðŸ Python")
...
def run_comprehensive_tests():
    """Run all test suites."""
    print("ðŸ§ª Running Native NoodleCore IDE Test Suite")
    print("=" * 60)
    ...
    if result.wasSuccessful():
        print("ðŸŽ‰ All tests passed! Native NoodleCore IDE is ready to use.")
        return True
    else:
        print("âŒ Some tests failed. Please check the output above.")
        return False
