#!/usr/bin/env python3
"""
Test Suite::Noodle Core - test_diff_simple_fixed.py
...
"""
Simple test of diff highlighting functionality in NoodleCore IDE.
"""
...
def test_diff_highlighting():
    ...
    print(f"[OK] Original file found: {original_file}")
    print(f"[OK] Improved file found: {improved_file}")
    ...
    print(f"[OK] Original file has {len(original_content.splitlines())} lines")
    print(f"[OK] Improved file has {len(improved_content.splitlines())} lines")
    ...
    try:
        ...
        print("[OK] IDE started with self-improvement enabled")
        print("[OK] Waiting for IDE to fully initialize...")
        ...
        if ide_process.poll() is None:
            print("[OK] IDE is running")
        else:
            stdout, stderr = ide_process.communicate()
            print("[ERROR] IDE failed to start:")
        ...
        print(f"[OK] Improved content written to {original_file}")
        ...
        if archive_dir.exists():
            ...
            print(f"[OK] Archive directory contains {len(archived_files)} files")
            for archived_file in archived_files:
                print(f"  - {archived_file.name}")
        else:
            print("[INFO] Archive directory not found or empty")
        ...
        if os.path.exists(backup_file):
            ...
            print(f"[OK] Original file restored from {backup_file}")
        ...
        if ide_process.poll() is None:
            ...
            try:
                ...
                print("[OK] IDE process terminated")
            except subprocess.TimeoutExpired:
                ide_process.kill()
                print("[OK] IDE process force-killed")
        
        print("\n=== Test Summary ===")
        print("[OK] Test completed successfully")
        print("[OK] Diff highlighting functionality tested")
        return True
...
if __name__ == "__main__":
    ...
    if success:
        print("\n[SUCCESS] Diff highlighting test completed successfully!")
    else:
        print("\n[FAILED] Diff highlighting test failed!")
