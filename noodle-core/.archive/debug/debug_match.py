#!/usr/bin/env python3
"""
Noodle Core::Debug Match - debug_match.py
...
"""
Debug script for match expression parsing test.
"""
...
# Simple match expression test case
test_code = """
match x {
    case 1 => "one";
    case _ => "other";
...
print("Testing simple match expression...")
