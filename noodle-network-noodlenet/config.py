"""
Noodle Network Noodlenet::Config - config.py
...
class NoodleNetConfig:
    ...
    routing_timeout: float = 300.0  # 5 minutes
    max_route_cost: float = 1000.0
    route_cache_size: int = 1000
    load_balance_strategy: str = "weighted"  # round_robin, load_based, fastest, weighted
    
    # Security
    enable_encryption: bool = False
    encryption_key: Optional[str] = None
    security_policy: str = "capability_based"  # capability_based, rbac, acl
    max_capabilities_per_node: int = 10
    capability_lifetime: int = 3600  # 1 hour
