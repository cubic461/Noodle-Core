...
class GenericTypeInferencer
    ...
    variance: Optional[Variance] = None) - TypeVariable):
    ...
    return_type: Optional['Type'] = None) - FunctionType):
...
class GenericClass
    ...
    #     def add_method(self, method: GenericFunction):""Add a method to the class"""
