...
target_line = position.line + 1  # Convert to 1-based
target_char = position.character + 1  # Convert to 1-based
...
target_char = position.character + 1
...
token.position.line == target_line
and target_char = token.position.column
and target_char < = token.position.column + len(token.value)
#         )):
...
line = token.position.line - 1,
character = token.position.column + len(token.value - 1,)
#                     ),
#                 ),
#             )
