...
class InstructionHandler
    ...
    max_tensor_size: int = 1024 * 1024 * 1024,
...
class NBCInstructionSet(InstructionHandler)
    ...
    max_tensor_size: int = 1024 * 1024 * 1024, is_distributed_enabled: bool = False:)
    ...
    #     def _initialize_instruction_handlers(self):""Initialize instruction handlers mapping."""
    ...
    result_tensor = self.tensor_memory[tensor_id1] + self.tensor_memory[tensor_id2]
    ...
    tensor = self.tensor_memory[tensor_id]
    result_tensor = tensor - self.numpy.trunc(tensor)
