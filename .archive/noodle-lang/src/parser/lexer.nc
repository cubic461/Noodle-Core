...
import pygments.filter.apply_filters
import pygments.filters.get_filter_by_name
import pygments.token.Error
import pygments.util.get_bool_opt
#     staticmethod, Future, guess_decode
import pygments.regexopt.regex_opt
...
class LexerMeta(type)
    ...
    d['analyse_text'] = staticmethod(d['analyse_text'])
...
class Lexer(metaclass=LexerMeta)
    ...
    #     def _preprocess_lexer_input(self, text):""Apply preprocessing such as decoding the input, removing BOM and normalizing newlines."""
...
class RegexLexerMeta(LexerMeta)
    ...
    #     def _process_regex(cls, regex, rflags, state):""Preprocess the regular expression component of a token definition."""
...
function do_insertions(insertions, tokens)
    #     """
