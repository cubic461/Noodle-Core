...
class MetadataManagerError(Exception):""Base exception for metadata manager operations."""
...
class MetadataManager
    ...
    #     def __init__(self, base_path: str = ".project/.noodle"):""Initialize the metadata manager.
