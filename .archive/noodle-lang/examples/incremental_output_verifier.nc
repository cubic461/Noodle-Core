...
class IncrementalOutputVerifier
    ...
    progress_delta = abs(expected_progress - last_progress)
    ...
    previous_checkpoint = self.checkpoints[ - 1]
    ...
    new_keys = output_keys - previous_keys
    missing_keys = previous_keys - output_keys
