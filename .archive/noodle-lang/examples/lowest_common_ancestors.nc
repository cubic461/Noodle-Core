...
import itertools.combinations_with_replacement

import networkx as nx
import networkx.utils.UnionFind
...
# @nx._dispatchable
function all_pairs_lowest_common_ancestor(G, pairs=None)
...
not_implemented_for("undirected")
# @nx._dispatchable
function lowest_common_ancestor(G, node1, node2, default=None)
...
not_implemented_for("undirected")
# @nx._dispatchable
function tree_all_pairs_lowest_common_ancestor(G, root=None, pairs=None)
