...
class CostBasedOptimizer
    ...
    #     def __init__(self, context: OptimizationContext):""Initialize the cost-based optimizer.
    ...
    cost = base_cost + children_total * self.context.cost_factors.filter_cost
    #         elif operation == "JOIN":
    cost = base_cost + children_total * self.context.cost_factors.full_scan_cost
    #         else:
    cost = (
    #                 base_cost
    ...
    speedup = 1 - (1 - efficiency) * (1 - 1 / cores)
    ...
    overhead = node.estimated_rows * 0.001
