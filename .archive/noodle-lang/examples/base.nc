...
class MathematicalObject(ABC)
    ...
    #         with self.lock:
    data = self.get_data()
    new_metadata = MathematicalObjectMetadata( * *self.metadata.__dict__)
    ...
    self.metadata = MathematicalObjectMetadata( * *metadata_dict)
...
#     """
metadata = MathematicalObjectMetadata( * *metadata_kwargs)
