...
function SubstituteInString(inString, evalEnv)
    substChar = "$"
...
function SubstituteInFile(inName, outName, evalEnv)
...
function VssLog(project, linePrefix="", noLabels=5, maxItems=150)
    lines = []
    num = 0
    labelNum = 0
...
function SubstituteVSSInFile(projectName, inName, outName)
    #     import win32api
...
function GetLastBuildNo(project)
...
function MakeNewBuildNo(project, buildDesc=None, auto=0, bRebrand=0)
