...
class CleanupManager
    ...
    #     def __init__(self, base_path: str = ".project/.noodle"):""Initialize the cleanup manager.
    ...
    #                 if file_mtime < cutoff_date:
    file_size_mb = preview_file.stat().st_size / (1024 * 1024)
    ...
    file_size_mb = approval_file.stat().st_size / (1024 * 1024)
    ...
    cutoff_date = datetime.now() - timedelta(days=3  # Compress logs older than 3 days)
