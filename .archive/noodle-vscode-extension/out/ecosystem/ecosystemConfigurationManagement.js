...
exports.EcosystemConfigurationManagement = void 0;
const vscode = __importStar(require("vscode"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const yaml = __importStar(require("js-yaml"));
class EcosystemConfigurationManagement {
    constructor(context) {
        ...
        this.statusBarItem = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 105);
    ...
    async createBackup() {
        ...
        const backupPath = path.join(this.context.globalStorageUri.fsPath, `backups/ecosystem-config-${timestamp}.yaml`);
    ...
    async exportConfiguration(filePath) {
        try {
            ...
            const exportPath = filePath || path.join(this.context.globalStorageUri.fsPath, `exports/ecosystem-config-${new Date().toISOString().split('T')[0]}.yaml`);
    ...
    async importConfiguration(filePath) {
        try {
            ...
            const importedConfig = configData;
...
exports.EcosystemConfigurationManagement = EcosystemConfigurationManagement;
//# sourceMappingURL=ecosystemConfigurationManagement.js.map