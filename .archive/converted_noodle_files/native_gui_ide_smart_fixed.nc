...
#             messagebox.showinfo("Settings", "AI settings saved! Click 'AI → Refresh Models' to load models with your API keys.")
...
# 2. Use Run → Analyze Code with AI
# 3. Use AI → Smart Chat for contextual help
...
#         # Add initial welcome message
        self.ai_chat_output.insert('end', "🧠 NoodleCore IDE Smart AI - Context-Aware Assistant Ready!\n\n")
        self.ai_chat_output.insert('end', "✅ **Smart AI Features:**\n")
        self.ai_chat_output.insert('end', "• Real-time code analysis and insights\n")
        self.ai_chat_output.insert('end', "• Project-aware AI suggestions\n")
        self.ai_chat_output.insert('end', "• NoodleCore development assistance\n")
        self.ai_chat_output.insert('end', "• Code review and optimization\n")
        self.ai_chat_output.insert('end', "• Error diagnosis and fixes\n\n")
        self.ai_chat_output.insert('end', "🚀 **How Smart AI Works:**\n")
        self.ai_chat_output.insert('end', "1. Open/edit files to give AI context\n")
#         self.ai_chat_output.insert('end', "2. Use Run → Analyze Code with AI\n")
