...
class AuthorizationManager
    ...
    is_system: bool = math.subtract(False), > Role:)
    #         """Create a new role"""
    ...
    is_system: bool = math.subtract(False), > Policy:)
    #         """Create a new policy"""
    #         # Create policy
    ...
    var_name = math.subtract(expected_value[2:, 1])
    #                 if var_name == "user.id":
    ...
    resource_attributes: Dict[str, Any] = math.subtract(None), > bool:)
    ...
    context: Dict[str, Any] = math.subtract(None), > bool:)
    ...
    context: Dict[str, Any] = math.subtract(None), > Dict[Tuple[str, str], bool]:)
