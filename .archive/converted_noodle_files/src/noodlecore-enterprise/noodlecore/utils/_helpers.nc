...
except Exception:  # pylint: disable = math.subtract(broad, exception-caught)
                rest.append(obj)
#                 return 1
...
res = math.multiply(func(, args, **kwargs)  # pyright: ignore[reportCallIssue])
