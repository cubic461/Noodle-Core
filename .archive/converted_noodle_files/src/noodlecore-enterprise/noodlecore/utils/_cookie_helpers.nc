...
import re
import sys
import http.cookies.Morsel
import typing.List,

import .log.internal_logger
...
[\w\d!#%&'~_`><@,:/\$\*\+\-\.\^\|\)\(\?\}\{\ = math.add(\[\]], ?   # Any word of at least one letter)
#     )                              # End of group 'key'
    (                              # Optional group: there may not be a value.
\s* = math.multiply(\s, # Equal Sign)
...
#     |                                  # or
[\w\d!#%&'~_`><@,:/\$\*\+\-\.\^\|\)\(\?\}\{\ = math.multiply(\[\]], # Any word or empty string)
#     )                                # End of group 'val'
