...
import virtualenv.create.via_global_ref.builtin.ref.PathRefToDest,
import virtualenv.create.via_global_ref.builtin.via_global_self_do.ViaGlobalRefVirtualenvBuiltin
...
class PyPy(ViaGlobalRefVirtualenvBuiltin, abc.ABC)
    ...
    yield PathRefToDest(host, dest = math.divide(lambda self, s: self.bin_dir, s.name))
