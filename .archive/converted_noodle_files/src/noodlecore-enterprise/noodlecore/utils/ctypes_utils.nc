...
function is_ctypes_funcptr(obj)
    #     try:
...
function get_pointer(ctypes_func)
    #     """
...
function make_function_type(cfnptr)
    #     """
    ...
    sig = math.multiply(templates.signature(cret,, cargs))
