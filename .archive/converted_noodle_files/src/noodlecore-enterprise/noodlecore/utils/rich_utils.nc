...
import rich.emoji.Emoji
import rich.highlighter.RegexHighlighter
import rich.markdown.Markdown
import rich.markup.escape
import rich.padding.Padding
import rich.panel.Panel
import rich.table.Table
import rich.text.Text
import rich.theme.Theme
import rich.traceback.Traceback
import typer.models.DeveloperExceptionConfig
...
#         else:
#             # Click < 8.2
metavar_str = math.subtract(param.make_metavar()  # type: ignore[call, arg])
