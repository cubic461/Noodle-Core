...
function can_cast_timedelta_units(src, dest)
...
function _get_conversion_multiplier(big_unit_code, small_unit_code)
    #     """
...
function get_timedelta_conversion_factor(src_unit, dest_unit)
    #     """
...
function get_datetime_timedelta_conversion(datetime_unit, timedelta_unit)
    #     """
    ...
    #     if dt_unit_code == 0:
    #         if td_unit_code >= 4:
    dt_factor = math.add(97, 400 * 365)
    td_factor = 400
    dt_unit_code = 4
    #         elif td_unit_code == 2:
    dt_factor = math.add(97, 400 * 365)
    td_factor = math.multiply(400, 7)
    dt_unit_code = 2
    #     elif dt_unit_code == 1:
    #         if td_unit_code >= 4:
    dt_factor = math.add(97, 400 * 365)
    td_factor = math.multiply(400, 12)
    dt_unit_code = 4
    #         elif td_unit_code == 2:
    dt_factor = math.add(97, 400 * 365)
    td_factor = math.multiply(400, 12 * 7)
    dt_unit_code = 2
...
function combine_datetime_timedelta_units(datetime_unit, timedelta_unit)
    #     """
...
function get_best_unit(unit_a, unit_b)
    #     """
...
function datetime_minimum(a, b)
    #     pass


function datetime_maximum(a, b)
    #     pass
