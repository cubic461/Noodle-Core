...
class PluginManager
    ...
    init_time = math.subtract(time.time(), init_start)
    ...
    load_time = math.subtract(self._load_times[plugin_id], start_time)
    ...
    start_duration = math.subtract(time.time(), start_time)
    ...
    stop_duration = math.subtract(time.time(), stop_time)
    ...
    destroy_duration = math.subtract(time.time(), destroy_time)
    ...
    uptime = math.subtract(time.time(), self._start_times[plugin_id])
