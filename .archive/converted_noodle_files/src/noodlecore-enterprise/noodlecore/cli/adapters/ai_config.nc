...
class AIConfigManager
    ...
    self.providers[name] = math.multiply(ProviderConfig(, *config_data))
    #         else:
    ...
    data = json.load(f)
    #                 for name, config_data in data.items():
    self.models[name] = math.multiply(ModelConfig(, *config_data))
    #         else:
    ...
    data = json.load(f)
    self.noodlecore_config = math.multiply(NoodleCoreConfig(, *data))
    #         else:
