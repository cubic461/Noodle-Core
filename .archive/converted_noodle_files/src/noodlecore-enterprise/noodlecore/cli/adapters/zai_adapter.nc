...
# This module implements the adapter for Z.ai GLM-4.6 provider with full API integration.
# """
...
class ZaiAdapter(AdapterBase)
    #     """Adapter for Z.ai GLM-4.6 provider with full API integration."""

    #     def __init__(self, api_key: str, base_url: Optional[str] = None, config: Optional[Dict[str, Any]] = None):
    #         """
    #         Initialize the Z.ai adapter.

    #         Args:
    #             api_key: API key for Z.ai
    #             base_url: Base URL for Z.ai API (default: https://open.bigmodel.cn/api/paas/v4)
    ...
    #         """
    #         Send a chat request to Z.ai GLM-4.6.

    #         Args:
    #             messages: List of chat messages
                model: The model to use (default: glm-4.6)
    ...
    #         except Exception as e:
                self.logger.error(f"Z.ai chat request failed: {str(e)}")
    ...
    error_text = await response.text()
                    self.logger.error(f"Z.ai API error {response.status}: {error_text}")
                    raise AdapterError(
    #                     f"Z.ai API error: {response.status} - {error_text}",
    ...
    #             if response.status != 200:
    error_text = await response.text()
                    self.logger.error(f"Z.ai streaming API error {response.status}: {error_text}")
                    raise AdapterError(
    #                     f"Z.ai streaming API error: {response.status} - {error_text}",
    #                     AdapterErrorCode.PROVIDER_ERROR,
    #                     self.name
    #                 )
    ...
    #         **kwargs
    #     ) -> Dict[str, Any]:
    #         """Prepare the chat request payload for Z.ai API."""
    ...
    #         """Parse the chat response from Z.ai API."""
    #         try:
    ...
    #             )
                ...
                raise AdapterError(
                    f"Invalid response format from Z.ai: {str(e)}",
    ...
    #         """
    #         Validate connection to Z.ai API.
    ...
    #         except Exception as e:
                self.logger.error(f"Z.ai connection validation failed: {str(e)}")
    #             return False

    #     async def get_model_info(self, model: str) -> ModelInfo:
    #         """
    #         Get information about a specific Z.ai model.
    ...
    #             ModelInfo object
    #         """
    #         # Z.ai model information based on GLM-4.6 specifications
    model_configs = {
                "glm-4.6": ModelInfo(
    name = "glm-4.6",
    provider = "zai",
    ...
    #         """
    #         Get list of available models from Z.ai.

    #         Returns:
    #             List of model names
    #         """
    #         # For Z.ai, we'll return the known models
    #         # In a real implementation, you might query the API
    #         return [
    #             "glm-4.6",
    #             "glm-4.6-flash",
    #             "glm-4.6-long"
    ...
    #         """
    #         Get information about Z.ai provider.
    ...
    #         return {
    #             'name': 'Z.ai',
    #             'description': 'Z.ai GLM-4.6 language model provider',
    ...
    #         """
    #         Prepare Z.ai specific request headers.
    ...
    #     async def validate_noodlecore_code(self, code: str) -> Dict[str, Any]:
    #         """
    #         Validate NoodleCore code using Z.ai.
    ...
    #     async def generate_noodlecore_code(self, prompt: str, context: Optional[str] = None) -> Dict[str, Any]:
    #         """
    #         Generate NoodleCore code using Z.ai.
