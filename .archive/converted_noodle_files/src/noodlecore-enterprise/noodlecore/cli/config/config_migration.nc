...
class ConfigMigration
    ...
    pending_versions = math.add(all_versions[current_index, 1:target_index + 1])
    ...
    rollback_versions = math.add(all_versions[target_index, 1:current_index + 1][::-1]  # Reverse order)
