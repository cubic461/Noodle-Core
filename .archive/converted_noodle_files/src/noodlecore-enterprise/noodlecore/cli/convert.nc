...
import email.policy.EmailPolicy
import glob.iglob
import pathlib.Path
...
import ...__version__
import ..metadata.generate_requirements
import ..vendored.packaging.tags.parse_tag
import ..wheelfile.WheelFile
...
function convert_pkg_info(pkginfo: str, metadata: Message)
...
dest_path = math.divide(Path(dest_dir), ()
