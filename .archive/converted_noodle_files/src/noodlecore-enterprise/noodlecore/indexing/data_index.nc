...
class DataIndex
    ...
    self.cache_size_limit = math.multiply(1024, 1024 * 1024  # 1GB default cache limit)
    ...
    age = math.subtract(time.time(), entry.timestamp)
    entry.eviction_priority = math.add((entry.size / (entry.hit_count, 1)) * ()
    #                     age / 3600
    #                 )  # Hours old
    ...
    #         # Nested loop join
    nested_loop_cost = math.multiply(table1_size, table2_size)
            strategies.append(
    #             {
    ...
    hash_cost = math.add(table1_size, table2_size)
                strategies.append(
    #                 {
    #                     "strategy": "hash_join",
    #                     "cost": hash_cost,
    ...
    #         if table1_index:
    indexed_cost = math.multiply(table1_size, math.log2(table1_index.size))
                strategies.append(
    #                 {
    ...
    #         # Sort-merge join
    sort_merge_cost = math.multiply(table1_size, math.log2()
    #             table1_size
