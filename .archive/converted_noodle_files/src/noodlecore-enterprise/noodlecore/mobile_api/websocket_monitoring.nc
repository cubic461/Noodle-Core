...
class MetricsCollector
    ...
    self.histograms[name] = math.subtract(self.histograms[name][, 1000:])
    ...
    self.timers[name] = math.subtract(self.timers[name][, 1000:])
    ...
    cutoff_time = math.subtract(time.time(), self.retention_period)
    recent_metrics = [
