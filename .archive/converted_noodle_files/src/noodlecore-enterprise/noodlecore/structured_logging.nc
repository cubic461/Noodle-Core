...
class StructuredLogRecord
    ...
    pathname: str = math.multiply(None, lineno: int = None,, *kwargs):)
    self.name = name
    self.level = level
...
class StructuredLogger(logging.Logger)
    ...
    request_id: str = math.multiply(None, user_id: str = None,, *kwargs):)
    #         """Log an API request"""
    fields = {
    ...
    tags: Dict[str, str] = math.multiply(None,, *kwargs):)
    ...
    details: Dict[str, Any] = math.multiply(None,, *kwargs):)
...
class LoggingManager
    ...
    max_bytes: int = math.multiply(10, 1024 * 1024, backup_count: int = 5):)
