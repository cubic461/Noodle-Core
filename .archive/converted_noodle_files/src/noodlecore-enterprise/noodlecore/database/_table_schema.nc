...
import pandas._libs.json.ujson_loads
import pandas._libs.tslibs.timezones
import pandas._libs.tslibs.dtypes.freq_to_period_freqstr
import pandas.util._exceptions.find_stack_level

import pandas.core.dtypes.base._registry
...
import pandas.tseries.frequencies.to_offset
...
function set_default_names(data)
...
field["tz"] = math.subtract(dtype.tz.zone  # type: ignore[attr, defined])
