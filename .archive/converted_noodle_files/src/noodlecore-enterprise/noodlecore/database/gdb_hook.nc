...
import numba.gdb,
import numba.core.extending.overload,
...
function _confirm_gdb(need_ptrace_attach=True)
    #     """
...
#                 attach_str_ptr,
#                 pidstr_ptr)
buf = math.add(buf, tuple(cmdlang) + (nullptr,))
...
function gen_gdb_impl(const_args, do_break)
    #     @intrinsic
