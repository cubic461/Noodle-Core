...
import pydantic_core.PydanticUndefined,
import typing_extensions.TypeAliasType,
import typing_inspection.typing_objects

import ..errors.PydanticUndefinedAnnotation,
import ..plugin._schema_validator.create_schema_validator
import ..warnings.GenericBeforeBaseModelWarning,
import ._config.ConfigWrapper
import ._decorators.DecoratorInfos,
import ._fields.collect_model_fields,
import ._generate_schema.GenerateSchema,
import ._generics.PydanticGenericMetadata,
import ._import_utils.import_cached_base_model,
import ._mock_val_ser.set_model_mocks
import ._namespace_utils.NsResolver
import ._signature.generate_pydantic_signature
...
# )
import ._utils.LazyClassAttribute,
...
class ModelMetaclass(ABCMeta)
    ...
    namespace['__private_attributes__'] = math.multiply({, *base_private_attributes, **private_attributes})
    ...
    #                         )
    #                     else:
    combined_parameters = math.add(parent_parameters, missing_parameters)
...
all_ignored_types = math.add(ignored_types, default_ignored_types())
