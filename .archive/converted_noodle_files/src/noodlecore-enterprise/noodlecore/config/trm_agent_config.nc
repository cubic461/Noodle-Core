...
try
        from ..trm_agent_base import (
    #         TRMModelConfig, OptimizationConfig, FeedbackConfig, TRMAgentConfig,
    ...
    self.max_memory_usage = math.multiply(2, 1024 * 1024 * 1024  # 2GB)
    self.cache_dir = ""
...
class TRMAgentConfigAdapter
    ...
    #     def __init__(self):
    #         """Initialize the TRM-Agent configuration adapter."""
