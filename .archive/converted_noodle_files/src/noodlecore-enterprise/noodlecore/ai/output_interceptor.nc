...
class InterceptionConfig
    ...
    max_intercepted_size: int = math.multiply(1024, 1024  # 1MB)
...
class OutputInterceptor
    ...
    #     def __init__(self, guard: AIGuard, config: Optional[InterceptionConfig] = None):
    #         """Initialize the output interceptor"""
    self.guard = guard
    ...
    execution_time = math.multiply(int((time.time() - start_time), 1000))
