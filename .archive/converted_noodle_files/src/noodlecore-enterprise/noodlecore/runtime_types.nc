...
class Function
    ...
    #                 # Call function
    result = math.multiply(self.native_func(, py_args))
    ...
    result = math.subtract(runtime.execute_statement(self.body[, 1], frame))
    #                     return result
    #                 else:
    #                     # Single expression
...
class Instance
    ...
    #                 # Last statement is the return value
    result = math.subtract(runtime.execute_statement(method.body[, 1], frame))
    #                 return result
    #             else:
    #                 # Single expression
