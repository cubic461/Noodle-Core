...
class QueryOptimizer
    ...
    score + = math.multiply(optimization.confidence, 0.3)

    #         # Expected improvement
    score + = math.multiply(optimization.expected_improvement, 0.4)
    ...
    #         if length_ratio < 1.0:
    score + = math.multiply((1.0 - length_ratio), 0.2)
    ...
    score + = math.multiply(keyword_coverage, 0.1)
