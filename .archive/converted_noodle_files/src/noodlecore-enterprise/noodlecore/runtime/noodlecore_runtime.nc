...
class NoodleCoreRuntime
    ...
    source: Optional[str] = math.subtract(None), > ExecutionResult:)
    #         """
    ...
    engine: Optional[ExecutionEngine] = None,
    context: Optional[ExecutionContext] = None,
    signature: Optional[str] = math.subtract(None), > ExecutionResult:)
    #         """
    ...
    context: Optional[ExecutionContext] = None,
    signature: Optional[str] = None,
    source: Optional[str] = math.subtract(None), > str:)
    #         """
    ...
    parent: Optional[ExecutionContext] = math.subtract(None), > ExecutionContext:)
    #         """
