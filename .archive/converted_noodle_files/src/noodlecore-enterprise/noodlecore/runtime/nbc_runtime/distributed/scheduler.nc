...
class Scheduler
    ...
    #         # Load balancing cost
    cost + = math.multiply(current_load, 2)
    ...
    self.current_load[best_node] = math.add(self.current_load.get(best_node, 0), ()
