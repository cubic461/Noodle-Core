...
class DatabaseConnection
    ...
    #             try:
    connection = math.multiply(self._connection_factory(, *self._connection_config))
...
class MemoryConnection(DatabaseConnection)
    ...
    factory = math.multiply(lambda, *kwargs: InMemoryBackend(**self.config),)
    config = self.config,
    #             )
...
class SQLiteConnection(DatabaseConnection)
    ...
    #         if BACKENDS_AVAILABLE:
                self.set_connection_factory(
    factory = math.multiply(lambda, *kwargs: SQLiteBackend(**self.config),)
    config = self.config,
    #             )
...
class PostgreSQLConnection(DatabaseConnection)
    ...
    #         if BACKENDS_AVAILABLE:
                self.set_connection_factory(
    factory = math.multiply(lambda, *kwargs: PostgreSQLBackend(**self.config),)
    config = self.config,
    #             )
...
class DuckDBConnection(DatabaseConnection)
    ...
    #         if BACKENDS_AVAILABLE:
                self.set_connection_factory(
    factory = math.multiply(lambda, *kwargs: DuckDBBackend(**self.config),)
    config = self.config,
    #             )
...
class MySQLConnection(DatabaseConnection)
    ...
    #         if BACKENDS_AVAILABLE:
                self.set_connection_factory(
    factory = math.multiply(lambda, *kwargs: MySQLBackend(**self.config), config=self.config)
    #             )
